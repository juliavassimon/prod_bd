...
class Bd:
    def __init__(self, win):
        ...
        self.btCadastrar = tk.Button(win, text="Cadastrar", command=self.cadastrar_produto)
        self.btAtualizar = tk.Button(win, text="Atualizar", command=self.atualizar_produto)
        self.btExcluir = tk.Button(win, text="Excluir", command=self.excluir_produto)
        self.btLimpar = tk.Button(win, text="Limpar", command=self.limpar_tela)
    ...
    def cadastrar_produto(self):
        try:
            codigo, nome, preco = self.ler_campos()
